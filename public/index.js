...
var _Comments = __webpack_require__(88);

var _Comments2 = _interopRequireDefault(_Comments);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_Comments2.default, null), document.getElementById('root'));(function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'label',
          { className: 'sr-only', htmlFor: 'author' },
          'Author'
        ),
        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'author', name: 'author', placeholder: 'Author' }),
        _react2.default.createElement(
          'label',
          { className: 'sr-only', htmlFor: 'comment' },
          'Comment'
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'comment', name: '', placeholder: 'Comment' })
        ),
        _react2.default.createElement(
          'button',
...
var handleGroupItemMouse = function handleGroupItemMouse(event) {
  event.stopPropagation();

  var method = event.type === 'mouseenter' ? 'add' : 'remove';
  event.currentTarget.classList[method]('active');
};
var handleDeleteBtnClick = function handleDeleteBtnClick(event) {
...
var CommentItem = function CommentItem(_ref) {
  ...
  return _react2.default.createElement(
    'li',
    { className: 'list-group-item', onMouseEnter: handleGroupItemMouse, onMouseLeave: handleGroupItemMouse },
    _react2.default.createElement(
      'span',
      null,
      author,
    ...
    _react2.default.createElement(
      'button',
      { type: 'button', className: 'btn btn-danger btn-sm', style: { position: 'absolute', top: '50%', right: '10px', transform: 'translate3d(0, -50%, 0)' }, 'data-id': id, onClick: handleDeleteBtnClick },
      'x'
    )
  );
};
...
var _CommentItem = __webpack_require__(86);
...
var CommentList = function (_Component) {
  ...
  function CommentList(props) {
    ...
    _this.handleGroupItemMouse = _this.handleGroupItemMouse.bind(_this);
  ...
  _createClass(CommentList, [{
    key: 'handleGroupItemMouse',
    value: function handleGroupItemMouse(event) {
      event.stopPropagation();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        comments.map(function (item) {
          return _react2.default.createElement(_CommentItem2.default, _extends({ key: item.id }, item));
        })
      );
    }
  }]);
...
var _CommentForm = __webpack_require__(85);

var _CommentForm2 = _interopRequireDefault(_CommentForm);

var _CommentList = __webpack_require__(87);
...
var Comments = function (_Component) {
  ...
  _createClass(Comments, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _utils.fetch)('/api/comments').then(function (res) {
        return res.json();
      }).then(function (json) {
    ...
    value: function handleCommentDelete(event) {
      var _this3 = this;
      ...
      (0, _utils.fetch)('/api/comments/' + id, {
        method: 'delete'
      }).then(function (res) {
        return res.json();
      }).then(function (json) {
        if (json.error_code === 0) {
          _this3.setState({
            comments: _this3.state.comments.filter(function (item) {
              return item.id !== id;
            })
          });
        }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_CommentForm2.default, { onSubmit: this.handleSubmit }),
...
var fetch = exports.fetch = function fetch(api) {
